...
USEFORM("technology\support_modules\catalog_workpieces\FormAddZag.cpp", FormAddZagCode);
...
USEFORM("searcher\Location.cpp", LocationForm);
...
WINAPI _tWinMain(HINSTANCE, HINSTANCE, LPTSTR, int)
{
	...
	try
	{
		...
		Application->CreateForm(__classid(TFormAddZagCode), &FormAddZagCode);
		Application->CreateForm(__classid(TLocationForm), &LocationForm);
		Application->Run();
	}
