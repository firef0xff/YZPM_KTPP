...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`ffroot`@`%`*/ /*!50003 PROCEDURE `getZakazContent`(zakaz_id int)
BEGIN
	#Routine body goes here...
		SELECT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`ffroot`@`%`*/ /*!50003 PROCEDURE `getZakazes`(str varchar(255),  type tinyint(1), pg_num int, pg_size int)
BEGIN
	#Routine body goes here...
	if (type = 0)
		THEN 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`ffroot`@`%`*/ /*!50003 PROCEDURE `setZakaz`(zakaz varchar(6),  description varchar(255))
BEGIN
	#Routine body goes here...
	DECLARE id int;
	set id=0;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`ffroot`@`%`*/ /*!50003 PROCEDURE `setZakazContent`(zakaz_id int, det_id int, kol int)
BEGIN
	#Routine body goes here...
...
insert into materials (obmid,eic,nama,goma,prma,gopr,ves,eiv,sklad)
SELECT b.id,c.kodei,trim(a.nama),trim(a.goma),trim(a.prma),trim(a.gopr),a.ves,d.kodei,a.sklad from temporary_tables.nsi032 a
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `bordereau_all`(obd text)
BEGIN
	#Routine body goes here...
...
if (left(b.obd,9)='000000000'and d.sklad is not null,if (concat(trim(c.pm),' ',trim(c.napr))  is not null,trim(concat(trim(c.pm),' ',trim(c.napr),' ',trim(d.sklad))),trim(d.sklad)),if (concat(trim(c.pm),' ',trim(c.napr))  is not null,trim(concat(trim(c.pm),' ',trim(c.napr))),''))as `Рассцеховка`,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `bordereau_cooperation`(obd text)
BEGIN
	#Routine body goes here...
Drop TEMPORARY TABLE if EXISTS constructions.output;
Drop TEMPORARY TABLE if EXISTS tmp;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `bordereau_litho`(obd varchar(100))
BEGIN
	#Routine body goes here...
Drop TEMPORARY TABLE if EXISTS constructions.output;
Drop TEMPORARY TABLE if EXISTS tmp;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `bordereau_stamping`(obd varchar(100))
BEGIN
Drop TEMPORARY TABLE if EXISTS constructions.output;
Drop TEMPORARY TABLE if EXISTS tmp;
Drop TEMPORARY TABLE if EXISTS itog;
...
-- Dump completed on 2013-08-07 21:16:33
