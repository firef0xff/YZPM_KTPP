...
if (sum(f.tsht*f.ksht*f.krop/f.kolod/*+f.tpz*/) is not null,ROUND(sum(f.tsht*f.ksht*f.krop/f.kolod/*+f.tpz*/),3),0) as tsht, 
if (sum(f.tsht*f.ksht*f.krop/f.kolod/*+f.tpz*/)*a.kol is not null,ROUND(sum(f.tsht*f.ksht*f.krop/f.kolod/*+f.tpz*/)*a.kol,3),0) as tpart,
...
-- Dump completed on 2013-08-28 21:45:36
